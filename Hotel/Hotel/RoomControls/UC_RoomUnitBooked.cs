...
namespace Hotel.RoomControls
{
    public partial class UC_RoomUnitBooked : UC_RoomUnitBase
    {
        ...
        public UC_RoomUnitBooked(string roomID, string roomTypeID, string cleanStatus, string roomStatus, string floor, string checkInStatus) : base(roomID, roomTypeID, cleanStatus, roomStatus, floor, checkInStatus)
        {
            InitializeComponent();
