...
namespace Hotel.RoomControls
{
    public partial class UC_RoomUnitOccupied : UC_RoomUnitBase
    {
        ...
        public UC_RoomUnitOccupied(string roomID, string roomTypeID, string cleanStatus, string roomStatus, string floor, string checkInStatus, string checkInDate, string checkOutDate) : base(roomID, roomTypeID, cleanStatus, roomStatus, floor, checkInStatus, checkInDate, checkOutDate)
        {
            InitializeComponent();
